    ...
    <section className="pt-32 pb-20 md:pt-48 md:pb-32 flex flex-col items-center flex-grow min-h-screen">
      <div className="flex flex-col md:flex-row items-center justify-between gap-12 w-full">
        <div className="flex flex-col items-start max-w-2xl">
          <div className="inline-flex items-center px-3 py-1 rounded-full border border-white/10 bg-white/5 text-xs text-gray-300 mb-6 backdrop-blur-sm">
          ...
          <p className="text-gray-400 text-lg md:text-xl mb-10 max-w-lg leading-relaxed">
            I'm Kittiwin Intaml, a Software Engineer crafting scalable applications and elegant interfaces with modern web technologies.
          </p>
          
          <div className="flex flex-wrap items-center gap-4">
            <button className="bg-white text-black hover:bg-gray-200 px-6 py-3 rounded-full font-medium transition-colors flex items-center group">
              View Projects
              <ArrowRight className="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </button>
            <button className="glass hover:bg-white/10 text-white px-6 py-3 rounded-full font-medium transition-colors flex items-center border border-white/10">
        ...
        <div className="hidden lg:block w-full max-w-md relative">
          ...
          <div className="relative rounded-2xl glass border border-white/10 p-6 shadow-2xl">
            ...
            <pre className="text-sm font-mono text-gray-300 overflow-x-auto">
              <code>
                ...
                <br/>
                {'  '}name: <span className="text-green-400">'Kittiwin Intaml'</span>,
                <br/>
