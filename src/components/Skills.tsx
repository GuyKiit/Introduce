    ...
    <section id="skills" className="py-24 border-t border-gray-200 dark:border-white/5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {skillsData.map((skill, index) => (
          <div
            key={index}
            className="p-6 rounded-xl glass hover:bg-gray-50 dark:hover:bg-white/5 transition-all duration-300 hover:-translate-y-2 cursor-default border border-transparent dark:border-white/5 hover:border-gray-300 dark:hover:border-[#4f3cdc]/50"
          >
            <div className="w-12 h-12 rounded-lg bg-white dark:bg-[#1a1a1a] flex items-center justify-center mb-6 border border-gray-200 dark:border-white/10">
              {skill.icon}
            </div>
